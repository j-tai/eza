...
impl Icons {
    ...
    const FILE_3D: char         = '\u{f1b2}';  // 
    const FOLDER: char          = '\u{f114}';  // 
    const FOLDER_BUILD: char    = '\u{e5fc}';  // 
    ...
    const FOLDER_HIDDEN: char   = '\u{f114}';  // 
    const FOLDER_KEY: char      = '\u{f084}';  // 
    ...
    const PRIVATE_KEY: char     = '\u{f084}';  // 
    const PUBLIC_KEY: char      = '\u{eb11}';  // 
    const QT: char              = '\u{f375}';  // 
    const RAZOR: char           = '\u{f1fa}';  // 
    const REACT: char           = '\u{e7ba}';  // 
    const README: char          = '\u{eaa4}';  // 
    const SHEET: char           = '\u{f1c3}';  // 
    const SHELL: char           = '\u{f489}';  // 
    const SHELL_CMD: char       = '\u{f489}';  // 
    const SHIELD_CHECK: char    = '\u{f510}';  // 
    const SHIELD_KEY: char      = '\u{f43d}';  // 
    const SHIELD_LOCK: char     = '\u{f511}';  // 
    const SIGNED_FILE: char     = '\u{eec3}';  // 
